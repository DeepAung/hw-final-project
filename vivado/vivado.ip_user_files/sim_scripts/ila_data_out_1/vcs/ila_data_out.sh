...
#
# Script generated by Vivado on Wed Apr 22 12:45:47 +07 2026
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../../../opt/Xilinx/2025.2/data/rsb/busdef" +incdir+"../../../../vivado.gen/sources_1/ip/ila_data_out_1/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../../../../opt/Xilinx/2025.2/data/rsb/busdef" +incdir+"../../../../vivado.gen/sources_1/ip/ila_data_out_1/hdl/verilog" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ila_data_out xil_defaultlib.glbl -o ila_data_out_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ila_data_out_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/deepaung/Courses/hw-syn-lab-i/final-project/vivado/vivado.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key ila_data_out_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ila_data_out_simv.daidir vcs_lib c.obj)
