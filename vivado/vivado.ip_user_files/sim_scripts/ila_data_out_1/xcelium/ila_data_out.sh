...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../../../../opt/Xilinx/2025.2/data/rsb/busdef" +incdir+"../../../../vivado.gen/sources_1/ip/ila_data_out_1/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../../../../opt/Xilinx/2025.2/data/rsb/busdef" +incdir+"../../../../vivado.gen/sources_1/ip/ila_data_out_1/hdl/verilog" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ila_data_out xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ila_data_out -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/deepaung/Courses/hw-syn-lab-i/final-project/vivado/vivado.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ila_data_out_sc.so .tmp_log xcelium_lib waves.shm c.obj)
